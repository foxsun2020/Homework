...
parser.add_argument('--base_image_path', type=str, default='image/spring.jpg', required=False,
                    help='Path to the image to transform.')
parser.add_argument('--style_reference_image_path', default='image/style_6.jpg', type=str, required=False,
